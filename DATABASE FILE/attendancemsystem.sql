...
-- --------------------------------------------------------
--
-- Table structure for table `tblattendancejustifications`
--

CREATE TABLE `tblattendancejustifications` (
  `Id` int(11) NOT NULL,
...
--
-- Indexes for table `tblattendancejustifications`
--
ALTER TABLE `tblattendancejustifications`
  ADD PRIMARY KEY (`Id`),
  ADD KEY `attendance_idx` (`attendanceId`),
...
--
-- AUTO_INCREMENT for table `tblattendancejustifications`
--
ALTER TABLE `tblattendancejustifications`
